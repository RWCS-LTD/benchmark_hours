...
| `sa_del_pw`, `sa_f_*`, `sa_edit_select`, `sa_del_select`, `sa_view`, `sa_bm_new_*`, `sa_dl_sort_*`, `sa_tab2_auditor` | various | Analytics tab |
...
| Analytics | `sa_del_btn`, `sa_del_confirm`, `sa_del_cancel1`, `sa_del_yes`, `sa_del_retry`, `sa_del_cancel2` | inline, non-widget only | ✅ |
